...
RULE_EDGE_MAP: dict[str, list[str]] = {
    "H1": ["Value_Loop_Edge", "User_Pain_Fit_Edge"],
    "H2": ["Execution_Gap_Edge", "Value_Loop_Edge"],
    "H3": ["Evidence_Grounding_Edge", "Value_Loop_Edge"],
    "H4": ["Market_Competition_Edge", "Risk_Pattern_Edge"],
    "H5": ["User_Pain_Fit_Edge", "Evidence_Grounding_Edge"],
    "H6": ["Market_Competition_Edge", "Risk_Pattern_Edge"],
    "H7": ["Innovation_Validation_Edge", "Evidence_Grounding_Edge"],
    "H8": ["Value_Loop_Edge", "Evidence_Grounding_Edge"],
    "H9": ["Market_Competition_Edge", "Risk_Pattern_Edge"],
    "H10": ["Execution_Gap_Edge"],
    "H11": ["Compliance_Safety_Edge", "Risk_Pattern_Edge"],
    "H12": ["Execution_Gap_Edge", "Value_Loop_Edge"],
    "H13": ["Innovation_Validation_Edge", "Evidence_Grounding_Edge"],
    "H14": ["Ontology_Grounded_Edge"],
    "H15": ["Evidence_Grounding_Edge"],
    "H16": ["Market_Competition_Edge", "Value_Loop_Edge"],
    "H17": ["Market_Competition_Edge", "Value_Loop_Edge"],
    "H18": ["Value_Loop_Edge", "Evidence_Grounding_Edge"],
    "H19": ["Market_Competition_Edge", "Evidence_Grounding_Edge"],
    "H20": ["Evidence_Grounding_Edge", "Risk_Pattern_Edge"],
    "H21": ["Execution_Gap_Edge"],
    "H22": ["Compliance_Safety_Edge", "Execution_Gap_Edge"],
    "H23": ["Innovation_Validation_Edge", "User_Pain_Fit_Edge"],
}
